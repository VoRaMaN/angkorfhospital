...
import { store } from '@/actions/App/Http/Controllers/SpecialItemController';
import { ref } from 'vue';
...
const getItemName = (inventoryId: number | null, inventoryItems: InventoryItem[]) => {
    if (!inventoryId) return 'Select item';
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 sm:text-sm"
                                    />
                                    <p v-if="errors.unit_price" class="mt-2 text-sm text-red-600 dark:text-red-400">
                                        {{ errors.unit_price }}
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mb-3 text-sm text-gray-500 dark:text-gray-400">
                                        Optionally add inventory items that are included with this special item.
                                    </p>
                                            ...
                                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {{ inventoryItem.name }} ({{ inventoryItem.type }})
                                                        </option>
                                                    </select>
                                                </div>
                                ...
                                <div class="flex justify-end gap-3">
                                    ...
                                    >
                                        {{ processing ? 'Creating...' : 'Create Special Item' }}
                                    </button>
                                </div>
                            </div>
                        </form>
