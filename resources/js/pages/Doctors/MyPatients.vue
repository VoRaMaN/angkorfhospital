...
import { Calendar, Phone, Mail } from 'lucide-vue-next';
        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">View and manage patients assigned to you</p>
                </div>
            </div>
                        ...
                        <TableRow v-for="patient in patients" :key="patient.id">
                            ...
                            <TableCell>
                                <div class="space-y-1">
                                    ...
                                    <div v-if="patient.phone" class="flex items-center gap-1 text-sm text-muted-foreground">
                                        <Phone class="h-3 w-3" />
                                        {{ patient.phone }}
                                    </div>
                                </div>
                            ...
                            <TableCell>
                                <div v-if="patient.last_visit" class="flex items-center gap-1">
