...
<template>
    <Head title="Culture Medium - Lab Inventory" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">Culture Medium Inventory</h1>
                    <p class="text-muted-foreground">
                        Manage culture medium lab supplies
                    </p>
                </div>
                <Button as-child>
                    ...
                    <TableBody>
                        ...
                        <TableRow v-if="props.cultureMedium.length === 0">
                            ...
                            >
                                ...
                                category "Culture Medium" to see them here.
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
