        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-muted-foreground">Create a comprehensive medical order with multiple items</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <CardHeader>
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>Add lab tests, procedures, imaging, and supplies</CardDescription>
                            </div>
                                ...
                                <Tabs v-model="activeLabPanel">
                                    ...
                                    <TabsContent v-for="panel in labPanels" :key="panel.id" :value="panel.id.toString()"
                                        ...
                                        <div class="text-sm text-muted-foreground flex justify-between items-center">
                                            ...
                                            <span class="text-xs text-muted-foreground">Panel contains {{ panel.items.length }} tests</span>
                                        </div>
                                            ...
                                            <div v-if="itemData.item.item_type === 'supply'" class="flex gap-3 items-end">
                                                <div class="flex-1">
                                                    ...
                                                    <Select @update:modelValue="(val) => selectInventoryItem(itemData.item, Number(val))">
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem v-for="invItem in props.inventoryItems" :key="invItem.id"
                                                                :value="invItem.id">
                ...
                <div class="flex gap-4">
                    <Button type="submit" :disabled="form.processing">
                        {{ form.processing ? 'Creating...' : 'Create Medical Order' }}
                    </Button>
                    <Button variant="outline" as-child>
