...
const props = defineProps<{
    ...
    existingReport: SpermFreezingData | null;
}>();
...
// ─── Form state ───────────────────────────────────────────────────────────────
const buildEmptyForm = (): SpermFreezingData => ({
...
const form = reactive<SpermFreezingData>(buildEmptyForm());
...
// ─── Print ────────────────────────────────────────────────────────────────────
const openPrintTab = (id: number) => window.open(`/sperm-freezing-reports/${id}/pdf`, '_blank');
...
const save = () => {
    ...
    const url = isEdit ? `/sperm-freezing-reports/${props.existingReport!.id}` : '/sperm-freezing-reports';
                ...
                <div class="relative w-full max-w-3xl rounded-2xl bg-background shadow-2xl">
                    ...
                    <div class="flex items-center justify-between border-b px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-cyan-100 dark:bg-cyan-900">
                                <ClipboardList class="h-5 w-5 text-cyan-600 dark:text-cyan-400" />
                            </div>
                            <div>
                                <h2 class="text-lg font-semibold">Sperm Freezing</h2>
                                <p class="text-xs text-muted-foreground">IVF LAB — Sperm Freezing Report</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6 px-6 py-5">
                        ...
                        <!-- ── Sperm Freezing Form ────────────────────────── -->
                        <div class="space-y-4">
                            <h3 class="text-center text-base font-bold tracking-wide underline">Sperm Freezing</h3>
                            ...
                            <!-- Appearance, Liquefaction, Viscosity -->
                            ...
                            <div class="rounded-lg border">
                                ...
                                <div class="divide-y">
                                    ...
                                    <div class="grid grid-cols-[120px_1fr_100px_auto] items-center gap-x-3 px-3 py-1.5">
                                        ...
                                        <span class="text-xs text-muted-foreground">million/ml.</span>
                                    ...
                                    <div class="grid grid-cols-[120px_1fr_100px_auto] items-center gap-x-3 px-3 py-1.5">
                                        ...
                                        <span class="text-xs text-muted-foreground">million</span>
                            ...
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <div class="rounded-lg border p-3 space-y-2">
                                    <Label class="text-xs font-semibold">Report By</Label>
                                ...
                                <div class="rounded-lg border p-3 space-y-2">
                                    <Label class="text-xs font-semibold">Approve By</Label>
