...
import { Activity, Circle, Filter, RotateCcw, User } from 'lucide-vue-next';
            ...
            <Card>
                <CardHeader class="pb-3">
                    <CardTitle class="flex items-center gap-2 text-lg">
                        ...
                        Online Now ({{ props.onlineUsers.length }})
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    <div v-if="props.onlineUsers.length > 0" class="flex flex-wrap gap-3">
                        <div
