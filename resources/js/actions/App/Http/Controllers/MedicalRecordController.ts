...
/**
* @see \App\Http\Controllers\MedicalRecordController::generateReport
 * @see app/Http/Controllers/MedicalRecordController.php:262
 * @route '/medical-records/{medical_record}/report'
 */
export const generateReport = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/medical-records/{medical_record}/report'
 */
generateReport.url = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { medical_record: args }
    }
 ...
 * @route '/medical-records/{medical_record}/report'
 */
generateReport.get = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: generateReport.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/medical-records/{medical_record}/report'
 */
generateReport.head = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: generateReport.url(args, options),
    method: 'head',
})
 ...
 * @route '/medical-records/{medical_record}/report'
 */
    const generateReportForm = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/medical-records/{medical_record}/report'
 */
        generateReportForm.get = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: generateReport.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/medical-records/{medical_record}/report'
 */
        generateReportForm.head = (args: { medical_record: string | number } | [medical_record: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const MedicalRecordController = { index, create, store, show, edit, update, destroy, generateReport }
