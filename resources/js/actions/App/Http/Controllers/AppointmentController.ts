...
const AppointmentController = { index, create, store, show, edit, update, destroy, calendar, updateStatus, convertToVisit, generateReport, generateLetter, exportMethod, export: exportMethod }
