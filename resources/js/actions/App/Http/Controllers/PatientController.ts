 ...
 * @see app/Http/Controllers/PatientController.php:370
...
const PatientController = { index, create, store, show, photo, edit, update, destroy, generateReport, downloadReport, generateSticker, generateLabel }
