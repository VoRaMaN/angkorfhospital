...
/**
* @see \App\Http\Controllers\BillingController::printTodaySummary
 * @see app/Http/Controllers/BillingController.php:589
 * @route '/billings-print-today'
 */
export const printTodaySummary = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: printTodaySummary.url(options),
    method: 'get',
})

printTodaySummary.definition = {
    methods: ["get","head"],
 ...
 * @route '/billings-print-today'
 */
printTodaySummary.url = (options?: RouteQueryOptions) => {
    return printTodaySummary.definition.url + queryParams(options)
}
 ...
 * @route '/billings-print-today'
 */
printTodaySummary.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: printTodaySummary.url(options),
    method: 'get',
})
/**
 ...
 * @route '/billings-print-today'
 */
printTodaySummary.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: printTodaySummary.url(options),
    method: 'head',
})
 ...
 * @route '/billings-print-today'
 */
    const printTodaySummaryForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: printTodaySummary.url(options),
        method: 'get',
    })
 ...
 * @route '/billings-print-today'
 */
        printTodaySummaryForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: printTodaySummary.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/billings-print-today'
 */
        printTodaySummaryForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: printTodaySummary.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    printTodaySummary.form = printTodaySummaryForm
/**
...
const BillingController = { exportMethod, printTodaySummary, index, create, store, show, edit, update, destroy, updateStatus, completePayment, sendBackToNurse, receive, recoverStuckRevision, recalculate, applyDiscount, generateReport, generateLetter, export: exportMethod }
