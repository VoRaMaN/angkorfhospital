...
const BillingController = { exportMethod, index, create, store, show, edit, update, destroy, updateStatus, completePayment, sendBackToNurse, receive, recalculate, generateReport, generateLetter, export: exportMethod }
