...
/**
* @see \App\Http\Controllers\VisitController::assignProcess
 * @see app/Http/Controllers/VisitController.php:344
 * @route '/visits/{visit}/assign-process'
 */
export const assignProcess = (args: { visit: number | { id: number } } | [visit: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: assignProcess.url(args, options),
    method: 'patch',
})

assignProcess.definition = {
    methods: ["patch"],
 ...
 * @route '/visits/{visit}/assign-process'
 */
assignProcess.url = (args: { visit: number | { id: number } } | [visit: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { visit: args }
    }
    ...
    return assignProcess.definition.url
            .replace('{visit}', parsedArgs.visit.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/visits/{visit}/assign-process'
 */
assignProcess.patch = (args: { visit: number | { id: number } } | [visit: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: assignProcess.url(args, options),
    method: 'patch',
})
 ...
 * @route '/visits/{visit}/assign-process'
 */
    const assignProcessForm = (args: { visit: number | { id: number } } | [visit: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: assignProcess.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PATCH',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/visits/{visit}/assign-process'
 */
        assignProcessForm.patch = (args: { visit: number | { id: number } } | [visit: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: assignProcess.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    assignProcess.form = assignProcessForm
/**
...
assignProcess: Object.assign(assignProcess, assignProcess),
assignDoctor: Object.assign(assignDoctor, assignDoctor),
notifyStaff: Object.assign(notifyStaff, notifyStaff),
}
