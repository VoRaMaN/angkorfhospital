                        ...
                        <div class="record-header">
                            ...
                            <div class="record-header-row">
                                ...
                                <div class="record-header-cell">
                                    ...
                                    <div class="record-value">{{ $appointment['status']?->label() ?? 'N/A' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="record-item">
                        <div class="record-header">
                            <div class="record-header-row">
                                ...
                                <div class="record-header-cell">
                                    <div class="record-label">Status:</div>
                                    <div class="record-value">{{ $visit['status']?->label() ?? 'N/A' }}</div>
                                </div>
                            </div>
                            <div class="record-header-row">
                                <div class="record-header-cell">
                        ...
                        <div class="record-header">
                            <div class="record-header-row">
                                <div class="record-header-cell">
                                    ...
                                    <div class="record-value">{{ $order['order_type']?->label() ?? 'N/A' }}</div>
                                </div>
                                <div class="record-header-cell">
                                    <div class="record-label">Status:</div>
                                    <div class="record-value">{{ $order['status']?->label() ?? 'N/A' }}</div>
                                </div>
                            </div>
                            <div class="record-header-row">
                                <div class="record-header-cell">
                        ...
                        <div class="record-header">
                            <div class="record-header-row">
                                <div class="record-header-cell">
                                    ...
                                    <div class="record-value">{{ $file['file_type']?->label() ?? 'N/A' }}</div>
                                </div>
                                <div class="record-header-cell">
