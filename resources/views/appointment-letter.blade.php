...
<body>
    ...
    <div class="content">
        <p>This letter confirms your appointment with CynoSys Clinic.</p>
    ...
    <div class="closing">
        <p>Sincerely,</p>
        <div class="signature">
            CynoSys Clinic Staff
        </div>
    </div>

    <div class="footer">
        <p>This is an official appointment confirmation from CynoSys Clinic. Please keep this letter for your records.</p>
