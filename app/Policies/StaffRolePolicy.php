...
class StaffRolePolicy
{
    ...
    {
        return $user->can('view_staff_roles') || $user->hasRole('admin');
    }
    ...
    {
        return $user->can('create_staff_roles') || $user->hasRole('admin');
    }
    ...
    {
        return $user->can('edit_staff_roles') || $user->hasRole('admin');
    }
    ...
    {
        return $user->can('delete_staff_roles') || $user->hasRole('admin');
    }
