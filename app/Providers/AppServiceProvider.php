            ...
            return [
                'user' => [
                    ...
                    'permissions' => [
                        ...
                        'view_prescriptions' => $user->can('view_prescriptions'),
                        'create_prescriptions' => $user->can('create_prescriptions'),
                        'edit_prescriptions' => $user->can('edit_prescriptions'),
                        'delete_prescriptions' => $user->can('delete_prescriptions'),
